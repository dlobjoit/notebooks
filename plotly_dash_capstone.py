...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        zeros = filtered_df['class'].tolist().count(0)
        ones = filtered_df['class'].tolist().count(1)
        fig = px.pie(values=[zeros, ones],
                     names=['0', '1'],
...
def get_scatter_chart(entered_site, slider):
    ...
    if entered_site == 'ALL':
        fig = px.scatter(data_frame=spacex_df,
                         ...
                         title='Payload mass vs Success of combined launch sites')
        return fig
    else:
        fig = px.scatter(data_frame=filtered_df,
                         ...
                         range_x=slider,
                         color="Booster Version Category",
                         title='Success of %s site' % entered_site)
        return fig
